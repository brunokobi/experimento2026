...
| 7.7 | Analise de sensibilidade: rotulo `direto` (148) vs. `direto+socio` (188) | `paper_en.md` Secao 4.5/5.3, `dissertacao_pt.md` Secao 4.5/5.3 | ✅ feito (15/08/2026) — tabela de razao lift `y_qualquer`/`y_direto` por rodada (1-4): HGT sempre a maior razao e sempre >1, tabular sempre <1; formaliza a leitura de exploracao de circularidade em vez de sinal estrutural genuino |
